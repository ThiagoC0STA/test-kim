  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center space-y-4">
        <h2 className={`text-4xl font-bold tracking-tight transition-colors duration-200 ${
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className={`hover:shadow-lg transition-all duration-200 ${
          ...
          <CardHeader className="pb-3">
            <div className={`w-12 h-12 rounded-lg flex items-center justify-center mb-2 transition-colors duration-200 ${
      ...
      {/* Account Info */}
      <Card className={`backdrop-blur-sm transition-colors duration-200 ${
        theme === 'dark' 
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              ...
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium transition-colors duration-200 ${
                theme === 'dark'
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <Card className={`text-center p-6 transition-colors duration-200 ${
          theme === 'dark' ? 'bg-slate-800 border-slate-700' : 'bg-white'
        }`}>
